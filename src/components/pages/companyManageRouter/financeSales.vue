...
export default {
  data () {
    return {
      ...
      tableThData1: jsonp.financeSalesTable.thData1,
      tableTdData1: jsonp.financeSalesTable.tdData1,
      headData: jsonp.financeSalesTable.headData,
      tableThData2: jsonp.financeSalesTable.thData2,
      tableTdData2: jsonp.financeSalesTable.tdData2
    }
  },
  created () {
    this.getCss()
