...
export default {
  data () {
    return {
      ...
      tableThData1: jsonp.financeRefundTable.thData1,
      tableTdData1: jsonp.financeRefundTable.tdData1,
      headData: jsonp.financeRefundTable.headData,
      tableThData2: jsonp.financeRefundTable.thData2,
      tableTdData2: jsonp.financeRefundTable.tdData2
    }
  },
  created () {
    this.getCss()
