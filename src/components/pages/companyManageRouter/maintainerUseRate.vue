...
export default {
  data () {
    return {
      ...
      tableThData1: jsonp.maintainerUseRateTable.thData1,
      tableTdData1: jsonp.maintainerUseRateTable.tdData1,
      headData: jsonp.maintainerUseRateTable.headData,
      tableThData2: jsonp.maintainerUseRateTable.thData2,
      tableTdData2: jsonp.maintainerUseRateTable.tdData2
    }
  },
  created () {
    this.getCss()
