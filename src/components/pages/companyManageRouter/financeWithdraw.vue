...
export default {
  data () {
    return {
      ...
      tableThData1: jsonp.financeWithdrawTable.thData1,
      tableTdData1: jsonp.financeWithdrawTable.tdData1,
      headData: jsonp.financeWithdrawTable.headData,
      tableThData2: jsonp.financeWithdrawTable.thData2,
      tableTdData2: jsonp.financeWithdrawTable.tdData2
    }
  },
  created () {
    this.getCss()
