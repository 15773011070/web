...
export default {
  data () {
    return {
      ...
      tableThData1: jsonp.storeClerkStatisticsTable.thData1,
      tableTdData1: jsonp.storeClerkStatisticsTable.tdData1,
      headData1: jsonp.storeClerkStatisticsTable.headData1,
      headData2: jsonp.storeClerkStatisticsTable.headData2,
      tableThData2: jsonp.storeClerkStatisticsTable.thData2,
      tableTdData2: jsonp.storeClerkStatisticsTable.tdData2,
      headData3: jsonp.storeClerkStatisticsTable.headData3,
      headList3: jsonp.storeClerkStatisticsTable.headList3,
      headData4: jsonp.storeClerkStatisticsTable.headData4,
      headList4: jsonp.storeClerkStatisticsTable.headList4
    }
  },
  created () {
    this.getCss()
