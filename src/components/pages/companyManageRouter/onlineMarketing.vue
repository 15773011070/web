...
import uwoManagement from '../../views/managementCommodity.vue'
export default {
  data () {
    return {
      ...
      tableThData1: jsonp.businessStaffTable.thData1,
      tableTdData1: jsonp.businessStaffTable.tdData1,
      headData: jsonp.businessStaffTable.headData,
      tableThData2: jsonp.businessStaffTable.thData2,
      tableTdData2: jsonp.businessStaffTable.tdData2
    }
  },
  created () {
    this.getCss()
